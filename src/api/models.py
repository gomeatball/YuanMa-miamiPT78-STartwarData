...
User_Planet_Favorites = Table('user_planet_favorites',
                              db.metadata,
                              Column('user_id', ForeignKey('user.id'),
                                     primary_key=True, nullable=False),
...
class User(db.Model):
    ...
    # children: Mapped[List["User_Person_Favorite"]] = relationship()


# relationship
    favorite_people: Mapped[list['Person']] = relationship(
        secondary=User_Person_Favorites, back_populates='favorited_by_user')
    favorite_planet: Mapped[list['Planet']] = relationship(
        secondary=User_Planet_Favorites, back_populates='favorited_by_user')
...
class Person(db.Model):
    ...
    favorited_by_user: Mapped[list['User']] = relationship(
        secondary=User_Person_Favorites, back_populates='favorite_people')
...
# relationships
    favorited_by_user: Mapped[list['User']] = relationship(
        secondary=User_Planet_Favorites, back_populates="favorite_planet")
